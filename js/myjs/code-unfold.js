...
(function ($) {
    ...
    $(document).ready(function () {
        $('body').on('click', '.js_unfold_code_btn', function () {
            $(this).closest('.js_line-numbers_container').addClass('on');
        });
        // 收起
        $('body').on('click', '.js_retract_code_btn', function () {
            var $container = $(this).closest('.js_line-numbers_container').removeClass('on');
        ...
        function addCodeWrap($node) {
            var $container = $node.wrap('<div class="js_line-numbers_container line-numbers-container"><div class="line-numbers-wrap"></div></div>').closest('.js_line-numbers_container');
